...
public class DisplayActivity extends Activity implements LogWriter.LogListener {
    ...
    private final List<BlockInfoEx> mBlockInfoEntries = new ArrayList<>();
        ...
        if (listAdapter instanceof BlockListAdapter) {
            ...
            mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    mBlockStartTime = mBlockInfoEntries.get(position).getStartTime();
                    updateUi();
                }
            });
    ...
    private class BlockListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            String index;
            if (position == 0 && mBlockInfoEntries.size() == sMaxStoreBlockCount) {
                index = "MAX. ";
            } else {
    ...
    private static class LoadBlocks implements Runnable {
        ...
        public void run() {
            ...
            File[] files = LogWriter.getLogFiles(sMaxStoreBlockCount);
            if (files != null) {
            ...
            mainHandler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    if (activityOrNull != null) {
                        activityOrNull.mBlockInfoEntries.clear();
                        activityOrNull.mBlockInfoEntries.addAll(blockInfoList);
